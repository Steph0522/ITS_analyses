...
ruta_fastq <- "/home/yendi/Documents/ITS_corredor/ITS_analysis/all_seqs/trimmed_merged/"

# Crear carpeta para guardar resultados de ITS y ajusta directorio de trabajo
ruta_resultados_ITS <- "/home/yendi/Documents/ITS_corredor/ITS_analysis/all_seqs/trimmed_merged/"
...
primeres_detected <- rbind(FWD.ForwardReads = sapply(FWD.orients, primerHits, fn = fnFs.filtN[[50]]), 
                           #FWD.ReverseReads = sapply(FWD.orients, primerHits, fn = fnRs.filtN[[1]]), 
                           REV.ForwardReads = sapply(REV.orients, primerHits, fn = fnFs.filtN[[50]]))
...
save( errF, dadaFs,  seqtab_nochim, taxa,
     file = "ITS_dada2_results_trimmed_merged.RData")
write.csv(taxa, "~/Documents/ITS_corredor/ITS_analysis/all_seqs/trimmed_merged///taxonomy.csv")
write.csv(seqtab_nochim, "~/Documents/ITS_corredor/ITS_analysis/all_seqs/trimmed_merged///table.csv")
 write.csv(stats, "~/Documents/ITS_corredor/ITS_analysis/all_seqs/trimmed_merged///stats.csv")
