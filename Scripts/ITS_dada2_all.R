...
save(errR, errF, dadaFs, dadaRs, mergers, seqtab_nochim, taxa,
     file = "~/Documents/ITS_corredor/ITS_analysis/all_seqs/raw/ITS_dada2_results.RData")

write.csv(taxa, "~/Documents/ITS_corredor/ITS_analysis/all_seqs/raw/taxonomy.csv")
write.csv(seqtab_nochim, "~/Documents/ITS_corredor/ITS_analysis/all_seqs/raw/table.csv")
write.csv(stats, "~/Documents/ITS_corredor/ITS_analysis/all_seqs/raw/stats.csv")
