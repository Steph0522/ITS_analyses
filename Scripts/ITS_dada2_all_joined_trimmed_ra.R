...
#if (!requireNamespace("BiocManager", quietly=TRUE))w
...
ruta_fastq <- "/home/yendi/Documents/ITS_corredor/all_seqs/joined_trimmed_raw/joined_trimmed/"

# Crear carpeta para guardar resultados de ITS y ajusta directorio de trabajo
ruta_resultados_ITS <- "/home/yendi/Documents/ITS_corredor/all_seqs/joined_trimmed_raw/resultados/"
...
head(sample.names)
sample.names<- str_sub(sample.names, - 4,-1)
