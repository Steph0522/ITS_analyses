...
ruta_fastq <- "/home/yendi/Documents/ITS_corredor/ITS_analysis/all_seqs/trimmed/"

# Crear carpeta para guardar resultados de ITS y ajusta directorio de trabajo
ruta_resultados_ITS <- "/home/yendi/Documents/ITS_corredor/ITS_analysis/all_seqs/trimmed/resultados/"
...
save(errR, errF, dadaFs, dadaRs, mergers, seqtab_nochim, taxa,
     file = "ITS_dada2_results_trimmed.RData")
write.csv(taxa, "~/Documents/ITS_corredor/ITS_analysis/all_seqs/trimmed//taxonomy.csv")
write.csv(seqtab_nochim, "~/Documents/ITS_corredor/ITS_analysis/all_seqs/trimmed//table.csv")
write.csv(stats, "~/Documents/ITS_corredor/ITS_analysis/all_seqs/trimmed//stats.csv")
