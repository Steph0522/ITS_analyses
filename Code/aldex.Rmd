...
all=plot_grid(p1 +xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")),
              p2+xlab("")+ylab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")),
              p3 +xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), 
              p4+ xlab("")+ylab("")+theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), 
              p5+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")),
              p6+ ylab("")+theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), 
...
pps=plot_grid(pp1+xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), pp2+ylab("")+xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), pp3+ylab("")+xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), 
              pp4+xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), pp5+ylab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm"))+xlab(""), pp6+ylab("")+xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), 
              pp7+xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), pp8+ylab("")+xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), pp9+xlab("")+ylab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")),
              pp10+xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")),pp11+ylab("")+xlab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), pp12+ylab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm"))+xlab(""), 
              pp13+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")),pp14+ylab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), pp15+ylab("")+ theme(plot.margin = unit(c(0.3, 0.4, 0.2, 0.2), "cm")), ncol = 3, nrow = 5, align = "hv", labels = "AUTO")


pps


ggsave("../Plots/aldex_polss_volcano_bh.png", plot = pps, device = "png", width = 13, height = 13, dpi = 300)
