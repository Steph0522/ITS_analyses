...
aldex_polygon_filt = aldex_polygon %>% filter(kw.eBH<0.05)

#write.csv(aldex_polygon_filt, "aldex_polygon_filt.csv")

aldex_dry = aldex(tab_polygon_dry, conditions = vector_polygon_dry, mc.samples = 128,denom = "all", test = "kw")

aldex_dry_filt = aldex_dry %>% filter(kw.ep < 0.05)

aldex_rainy = aldex(tab_polygon_rainy, conditions = vector_polygon_rainy, mc.samples = 128,denom = "all", test = "kw")
aldex_rainy_filt = aldex_rainy %>% filter(kw.ep < 0.05)

#write.csv(aldex_rainy_filt, "aldex_rainy_filt.csv")
