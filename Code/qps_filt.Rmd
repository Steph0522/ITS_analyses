...
abund_table=read_qza("../Data/table_SMOQ_filt.qza")$data #
tree = read_qza("../Data/tree_SMOQ_filt//rooted_tree.qza")$data
...
write.csv(phylo.sig.correlog$mantel.res, "../Data/ph_signal2.csv",  quote=F);
...
write.csv(phylo.sig.correlog$mantel.res, "../Data/mo_signal2.csv",  quote=F);
...
write.csv(phylo.sig.correlog$mantel.res, "../Data/p_signal2.csv",  quote=F);
...
write.csv(phylo.sig.correlog$mantel.res, "../Data/n_signal2.csv",  quote=F);
```
...
#pdf("phylo_signal2s.pdf")
png("../Plots/phylo_signal2s.png")


par(mfrow=c(2,2))
phylo.sig<-read.csv("../Data/ph_signal2.csv", row.names = 1, header=T, sep=",")
...
phylo.sig<-read.csv("../Data/mo_signal2.csv", row.names = 1, header=T, sep=",")
plot(phylo.sig[,c(1,3)],
           xlab="Phylogenetic Distance Class", ylab="Mantel Test Statistic") +lines(phylo.sig[,c(1,3)]) + points(phylo.sig[,c(1,3)], pch=21, bg="white", col="black", pty=4)+
  points(phylo.sig[,c(1,3)][phylo.sig[,4] < 0.05,], pch=21, bg="black", col="black", pty=4) + abline(h=0, lty=2, col="red") +
  title("OM")

phylo.sig<-read.csv("../Data/n_signal2.csv", row.names = 1, header=T, sep=",")
...
phylo.sig<-read.csv("../Data/p_signal2.csv", row.names = 1, header=T, sep=",")
plot(phylo.sig[,c(1,3)],
                   xlab="Phylogenetic Distance Class", ylab="Mantel Test Statistic") +lines(phylo.sig[,c(1,3)]) + points(phylo.sig[,c(1,3)], pch=21, bg="white", col="black", pty=4)+
  points(phylo.sig[,c(1,3)][phylo.sig[,4] < 0.05,], pch=21, bg="black", col="black", pty=4) + abline(h=0, lty=2, col="red") +
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI1d.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI2d.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI3d.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI4d.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI5d.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI6d.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI1r.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI2r.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI3r.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI4r.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI5r.csv",quote=F)
...
weighted.bNTI;
write.csv(weighted.bNTI, "./weighted2_bNTI6r.csv",quote=F)
...
```{r, eval=FALSE}
# For 16S dataset
comm=read_qza("../Data/table_SMOQ_filt.qza")$data #
Tree = read_qza("../Data/tree_SMOQ_filt/rooted_tree.qza")$data
...
source("../Scripts/raup_crick_abundance2.R")
library(phyloseq)
library(picante)
library(ape)
...
write.csv(as.matrix(rc1da), "./rc1da_abundance2.csv")
write.csv(as.matrix(rc2da), "./rc2da_abundance2.csv")
write.csv(as.matrix(rc3da), "./rc3da_abundance2.csv")
write.csv(as.matrix(rc4da), "./rc4da_abundance2.csv")
write.csv(as.matrix(rc5da), "./rc5da_abundance2.csv")
write.csv(as.matrix(rc6da), "./rc6da_abundance2.csv")

write.csv(as.matrix(rc1ra), "./rc1ra_abundance2.csv")
write.csv(as.matrix(rc2ra), "./rc2ra_abundance2.csv")
write.csv(as.matrix(rc3ra), "./rc3ra_abundance2.csv")
write.csv(as.matrix(rc4ra), "./rc4ra_abundance2.csv")
write.csv(as.matrix(rc5ra), "./rc5ra_abundance2.csv")
write.csv(as.matrix(rc6ra), "./rc6ra_abundance2.csv")
...
#1d
select_1d=read.csv("../Data/weighted2_bNTI1d.csv", check.names = F, row.names = 1)
head(select_1d)
...
#2d
select_2d=read.csv("../Data/weighted2_bNTI2d.csv", check.names = F, row.names = 1)
head(select_2d)
...
#3d
select_3d=read.csv("../Data/weighted2_bNTI3d.csv", check.names = F, row.names = 1)
head(select_3d)
...
#4d
select_4d=read.csv("../Data/weighted2_bNTI4d.csv", check.names = F, row.names = 1)
head(select_4d)
...
#5d
select_5d=read.csv("../Data/weighted2_bNTI5d.csv", check.names = F, row.names = 1)
head(select_5d)
...
#6d
select_6d=read.csv("../Data/weighted2_bNTI6d.csv", check.names = F, row.names = 1)
head(select_6d)
...
#1r
select_1r=read.csv("../Data/weighted2_bNTI1r.csv", check.names = F, row.names = 1)
head(select_1r)
...
#2r
select_2r=read.csv("../Data/weighted2_bNTI2r.csv", check.names = F, row.names = 1)
head(select_2r)
...
#3r
select_3r=read.csv("../Data/weighted2_bNTI3r.csv", check.names = F, row.names = 1)
head(select_3r)
...
#4r
select_4r=read.csv("../Data/weighted2_bNTI4r.csv", check.names = F, row.names = 1)
head(select_4r)
...
#5r
select_5r=read.csv("../Data/weighted2_bNTI5r.csv", check.names = F, row.names = 1)
head(select_5r)
...
#6r
select_6r=read.csv("../Data/weighted2_bNTI6r.csv", check.names = F, row.names = 1)
head(select_6r)
...
```{r}
rc1da = read.csv("../Data/rc1da_abundance2.csv")
#1d
...
#2d
rc2da = read.csv("../Data/rc2da_abundance2.csv")
...
#3d
rc3da = read.csv("../Data/rc3da_abundance2.csv")
...
#4d
rc4da = read.csv("../Data/rc4da_abundance2.csv")
...
#5d
rc5da = read.csv("../Data/rc5da_abundance2.csv")
...
#6d
rc6da = read.csv("../Data/rc6da_abundance2.csv")
...
#1r
rc1ra = read.csv("../Data/rc1ra_abundance2.csv")
...
#2r
rc2ra = read.csv("../Data/rc1ra_abundance2.csv")
...
#3r
rc3ra = read.csv("../Data/rc3ra_abundance2.csv")
...
#4r
rc4ra = read.csv("../Data/rc4ra_abundance2.csv")
...
#5r
rc5ra = read.csv("../Data/rc5ra_abundance2.csv")
...
#6r
rc6ra = read.csv("../Data/rc6ra_abundance2.csv")
...
data_plot = all %>% dplyr::select(
  ...
  Historical_contingency=percentage_histocont_displimit_ok  ) %>% pivot_longer(cols = -pol, names_to = "Process", values_to = "Proportion") %>% separate("pol", into = c("Polygon", "Season"), remove =  F)
...
ggsave("../Plots/process2.png",width = 8, height = 6, dpi = 300, plot = p, device = "png")
```
